...
const MVPCard = () => {
  ...
  const messages = [
    ...
    {
      title: "Your Spike",
      content: "Hits harder than the butterflies I felt on our first meetup 🦋💘"
    },
    {
      title: "Final Set",
      content: "Mothowak, you'll always have homecourt advantage in my heart. 🏡❤️"
    }
  ];
